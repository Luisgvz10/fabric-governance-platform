...
principal_fields = [f.name for f in bronze_item_access.schema["principal"].dataType.fields]

user_principal_name_expr = (
...
silver_item_access = (
    ...
    .select(
        ...
        user_principal_name_expr.alias("user_principal_name"),
